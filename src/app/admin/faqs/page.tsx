...
export default async function AdminFaqsPage() {
  ...
  if (error) {
    console.error('Error fetching site settings for FAQs:', error);
  }
  ...
  const mappedSettings = siteSettingsData ? {
    ...
    hero_mobile_image_url: siteSettingsData.hero_mobile_image_url || '',
  ...
  return <FaqsClient initialSettings={mappedSettings} />;
}
